...
export const FETCH_POLICY_CACHE_AND_NETWORK = 'cache-and-network'
...
function create(initialState, jwt) {
  ...
  const client = new ApolloClient({
    ...
    defaultOptions: {
      query: {
        fetchPolicy: (userRole && userRole === 'admin') ? FETCH_POLICY_NETWORK_ONLY : FETCH_POLICY_CACHE_AND_NETWORK
      }
    }
  })
