...
export const SELLER_ONBOARDING_PHONE_LOGIN_START = 'seller-onboarding-phone-login-start'
export const SELLER_ONBOARDING_PHONE_LOGIN_SUCCESS = 'seller-onboarding-phone-login-success'
export const SELLER_ONBOARDING_PHONE_LOGIN_CANCEL = 'seller-onboarding-phone-login-cancel'
...
// Estimate price
export const ESTIMATE_PRICE_OPEN = 'estimate-price-open'
export const ESTIMATE_PRICE_HOME_DETAILS = 'estimate-price-home-details'
export const ESTIMATE_PRICE_USER_INFO = 'estimate-price-user-info'
export const ESTIMATE_PRICE_FAIL = 'estimate-price-fail'
export const ESTIMATE_PRICE_SUCCESS = 'estimate-price-success'
export const ESTIMATE_PRICE_PUBLISH_LISTING = 'estimate-price-publish-listing'
