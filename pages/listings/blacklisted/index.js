...
import Listings from 'components/listings/blacklisted/Listings'

class BlacklistedListings extends Component {
  constructor(props) {
    super(props)
  ...
  getHead = () => {
    ...
    const title = 'Imóveis ocultados | EmCasa'
    const description = 'Meus imóveis ocultados'
...
export default BlacklistedListings
